...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            if let indexPath = self.tableView.indexPathForSelectedRow {
                ...
                controller.rssEvent = object as? RSSEvent
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("RSSEventCell", forIndexPath: indexPath) as! RSSEventCell
        let event = self.fetchedResultsController.objectAtIndexPath(indexPath) as! RSSEvent
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let aFetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: RSSCoreDataManager.sharedManager.managedObjectContext, sectionNameKeyPath: nil, cacheName: nil)
